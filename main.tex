...
\def\paperasciititle{Measurement of prompt Lambac+ baryon production cross-section and Lambdac+/D0 production ratio in pPb collisions at snn=8.16TeV} % Set ASCII title here
\def\papertitle{Measurement of prompt \Lc baryon production cross-section and \Lc/\Dz production ratio in $p$Pb collisions at $\sqsnn= 8.16\tev$ in LHCb} % Latex formatted title
...
\def\plead{\ensuremath{p\mathrm{Pb}\xspace}}
